...
class Utils {
	...
	async check_alerts() {
		...
		request.get("https://api.socialmanager.tools/v2/bot/facebook/alert/", function(err, res, json_alert) {
	...
	async check_sponsors() {
		...
		request.get("https://api.socialmanager.tools/v2/bot/facebook/sponsors/", function(err, res, json_sponsors) {
			if (err || res.statusCode !== 200) {
				this.log.error(tag, `${this.lang.translate("api_connection_error")}`);
				this.log.error(tag, `${err}`);
			} else {
	...
	async check_updates(version) {
		...
		request.get("https://api.socialmanager.tools/v2/bot/facebook/version/", function(err, res, last_release) {
			if (err || res.statusCode !== 200) {
				this.log.error(tag, `${this.lang.translate("api_connection_error")}`);
				this.log.error(tag, err);
