...
module.exports = {
	...
	"liked_previously": chalk`{italic.bold.rgb(246, 187, 67) </3} liked previously, use hashtag/localization with more posts. SKIPPED...`,
	...
	"try_write_comment": chalk`try write a comment`,
	"check_comment_exist": chalk`check if exist comment writed previously`,
	"comment_exist": chalk`comment exist, skipped...`,
	...
	"try_get_post_array": chalk`try get the posts array`,
	...
	"try_goto_post_page": chalk`try goto post page`,
	...
	"post_id": chalk`Post ID`,
	"post_ids": chalk`Post IDs`,
	"post_urls": chalk`Post URLs`,
	"cache_size": "cache check, array hashtags size is",
	"try_get_post_hash_id": "try get post id (hash)",
	"is_night_bot_sleep": "is night, bot sleep... wait...",
	"finish_fast_like": "finished fast like of 12 posts, wait ##time## minutes",
	"finish_like": "liked 1 post, wait ##time## minutes",
	...
	"twofa_not_work": chalk`If the two authentication does not work, we recommend disabling it. Once the bot is running you can activate it. This is an facebook (random) problem, if you try to login on the website you will receive the same error...`,
