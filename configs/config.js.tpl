module.exports = {
	...
	// Facebook Account
	"account": {
		"username": "ptkdev",   // facebook nickname
	...
	// likemode_classic            - select random hashtag from config list and like 1 random post (of last 20)
	// likemode_realistic          - select random hashtag from config list, like fast 10-12 post and sleep 15-20min
	// likemode_realistic_location - select random gps-location from config list, like fast 10-12 post and sleep 15-20min
	// likemode_realistic_timeline - like fast 10-12 post from your timeline and sleep 15-20min
	// likemode_superlike          - select random hashtag from config list and like 3 random post of same user
	// likemode_superlike_location - select random gps-location from config list and like 3 random post of same user
	// likemode_competitor_users   - select account, select random followers, like 10-12 post and sleep 15-20min
	// commentmode_classic         - leave a comment under the post via hashtag
	// commentmode_location        - leave a comment under the post via gps-location
	...
	//
	// Modes details: http://docs.socialmanager.tools/fbbot/installation/modes
	// Multi account: http://docs.socialmanager.tools/fbbot/installation/multiaccount
	"bot_mode": "likemode_realistic", // this is NOT array. 1 mode is allowed

	// Edit options of current bot_mode you use.
	"bot_mode_options": {
		"likemode_realistic": {
			"facebook_hashtag": ["rome", "italy", "muraleshunter"], // recommended more than 20
			"likeday_min": "800",      // min like daily.
			"likeday_max": "900",      // max like daily. In 2018 limit facebook is 1000/day
		...
		"likemode_realistic_location": {
			"facebook_location": ["213050058", "31499759", "675369430"], // recommended more than 20
			"likeday_min": "800",      // min like daily.
			"likeday_max": "900",      // max like daily. In 2018 limit facebook is 1000/day
			"sleep_night": "disabled", // if you need stop bot in night
			"sleep_end": "7:00",        // sleep from 00:00 to 7:00 am
		...
		"commentmode_realistic": {
			...
			"comments_max": "400",      // max comments daily. In 2018 limit facebook is 500/day
			"sleep_night": "disabled",  // if you need stop bot in night
			"sleep_end": "7:00",        // sleep from 00:00 to 7:00 am
			"database": {
		...
		"fdfmode_realistic": {
			"facebook_hashtag": ["rome", "italy", "muraleshunter"], // recommended more than 20
			"followday": "300",   // number of follow-defollow user/day, work in fdfmode_classic. In 2018 limit facebook is 500/day
		...
		"likemode_competitor_users": {
			"account": "user_nickname", // facebook nickname
			"likeday_min": "800",      // min like daily.
			"likeday_max": "900",      // max like daily. In 2018 limit facebook is 1000/day
			"sleep_night": "disabled",  // if you need stop bot in night
			"sleep_end": "7:00",        // sleep from 00:00 to 7:00 am
