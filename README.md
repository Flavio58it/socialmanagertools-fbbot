[![Social Manager Tools: IG BOT](https://raw.githubusercontent.com/social-manager-tools/socialmanagertools-fbbot/nightly/.github/assets/smt_fbbot_logo.png)](https://socialmanager.tools)

# 🤖 Social Manager Tools: 📷 Facebook Bot API

[![](https://img.shields.io/badge/version-v0.10.0--nightly.20190610-lightgrey.svg)](https://github.com/social-manager-tools/socialmanagertools-fbbot/releases) [![](https://img.shields.io/npm/v/@social-manager-tools/fbbot.svg)](https://www.npmjs.com/package/@social-manager-tools/fbbot) [![](https://img.shields.io/badge/license-MIT-brightgreen.svg)](#) [![](https://img.shields.io/badge/ES-9-F7DF1E.svg)](https://wikipedia.org/wiki/ECMAScript) [![](https://img.shields.io/badge/powered%20by-puppeteer-46aef7.svg)](https://github.com/GoogleChrome/puppeteer) [![](https://snyk.io/test/npm/@social-manager-tools/fbbot/badge.svg)](https://snyk.io/test/github/social-manager-tools/socialmanagertools-fbbot)

> This library (including bot and API methods) allow you to increase visits, likes and followers on your social profile through different algorithms and offers API for developers to include custom bot functionality in their  own applications. You will increase likes on your posts and your followers!

> ⛔ **DISCLAIMER**: This is an **unofficial** library and offers no warranty! The developers and contributors of the project do not assume any responsibility in case of ban of your account. Use of facebook bots does not comply with the terms of the service: use this software at your own risk. A "bot" is legal software, but the use of a bot continuously violates the terms of use of Facebook and you risk a: __soft ban__ (such as limited actions or follow-up) or you risk __ban__ with suspension for a few days (or permanent). All trademarks and logos belong to their respective owners.
...
- 💡 [Features](#-features)
- 💾 Installation:
	- 🔨 [Install From Source](http://docs.socialmanager.tools/fbbot/installation/source/README.md)
	- 🔨 [Install From NPM](http://docs.socialmanager.tools/fbbot/installation/npm/README.md)
	- 👨‍💻 [Desktop App](http://docs.socialmanager.tools/gui/installation/README.md) (Windows, Linux, Mac)
	- 🦀 [Raspberry PI](http://docs.socialmanager.tools/fbbot/installation/raspberry/README.md) (Raspbian 9)
	- 🐧 [Linux Server](http://docs.socialmanager.tools/fbbot/installation/linux/README.md) (Debian 9 Server)
	- 🐳 [Docker](http://docs.socialmanager.tools/fbbot/installation/docker/README.md)
- 🔑 Configs:
	- 🔌 [VPN/Proxy](http://docs.socialmanager.tools/fbbot/configs/vpn-proxy/README.md)
	- 💿 [List of Mode](http://docs.socialmanager.tools/fbbot/configs/modes/README.md)
	- 📀 [How set Multi-account](http://docs.socialmanager.tools/fbbot/configs/multiaccount/README.md)
...
- 📚 [API Documentation](http://docs.socialmanager.tools/fbbot/api/README.md) (How to create your personal bot or mode)
- 💻 [Developers Guidelines](http://docs.socialmanager.tools/developers/guidesline/README.md) (If you want to contribute)
- 🐛 [Known Bugs](https://github.com/social-manager-tools/socialmanagertools-fbbot/issues?q=is%3Aopen+is%3Aissue+label%3Abug)
- 🍻 Community:
...
## 🔖 Screenshot
[![](https://raw.githubusercontent.com/social-manager-tools/socialmanagertools-fbbot/master/.github/assets/screenshot/smt_fbbot_screenshot.gif)](#)
...
* [✔️] Like Mode Friends Feed Realistic: bot selects a random post from friends feed and likes fast 10-12 post, it sleeps 15-20min and repeats this all time. Sleeps at night.
...
```sh
docker run --restart=always --name=socialmanagertools-fbbot -d -v /path/to/configs/config.js:/app/configs/config.js socialmanagertools/fbbot:amd64
```
...
[![Twitch: prattquellolive](https://raw.githubusercontent.com/social-manager-tools/socialmanagertools-fbbot/nightly/.github/assets/patreon/prattquello.png)](https://www.twitch.tv/prattquellolive) [![JavaScript Room](https://raw.githubusercontent.com/social-manager-tools/socialmanagertools-fbbot/nightly/.github/assets/patreon/jsroom.png)](https://www.facebook.com/room_js/) [![](https://opencollective.com/social-manager-tools/backers.svg?width=890)](https://opencollective.com/social-manager-tools#backers)
...
<!-- prettier-ignore -->
<table><tr><td align="center"><a href="https://ptk.dev"><img src="https://avatars1.githubusercontent.com/u/442844?v=4" width="100px;" alt="Patryk Rzucidło"/><br /><sub><b>Patryk Rzucidło</b></sub></a><br /><a href="https://github.com/ptkdev/socialmanagertools-fbbot/commits?author=ptkdev" title="Code">💻</a> <a href="#translation-ptkdev" title="Translation">🌍</a> <a href="https://github.com/ptkdev/socialmanagertools-fbbot/commits?author=ptkdev" title="Documentation">📖</a> <a href="https://github.com/ptkdev/socialmanagertools-fbbot/issues?q=author%3Aptkdev" title="Bug reports">🐛</a></td><td align="center"><a href="https://twitter.com/maxfer75"><img src="https://raw.githubusercontent.com/social-manager-tools/socialmanagertools-fbbot/nightly/.github/assets/avatar/maxfer75.jpg" width="100px;" alt="MaXfer "/><br /><sub><b>MaXfer </b></sub></a><br /><a href="#design-maxfer75" title="Design">🎨</a></td><td align="center"><a href="https://twitter.com/tanik72"><img src="https://raw.githubusercontent.com/social-manager-tools/socialmanagertools-fbbot/nightly/.github/assets/avatar/tanik72.jpg" width="100px;" alt="Tanik"/><br /><sub><b>Tanik</b></sub></a><br /><a href="#design-TaniK72" title="Design">🎨</a></td><td align="center"><a href="https://github.com/agoalofalife"><img src="https://avatars1.githubusercontent.com/u/15719824?v=4" width="100px;" alt="Ilua Chubarov"/><br /><sub><b>Ilua Chubarov</b></sub></a><br /><a href="https://github.com/ptkdev/socialmanagertools-fbbot/commits?author=agoalofalife" title="Code">💻</a></td><td align="center"><a href="https://julianxhokaxhiu.com"><img src="https://avatars1.githubusercontent.com/u/1237070?v=4" width="100px;" alt="Julian Xhokaxhiu"/><br /><sub><b>Julian Xhokaxhiu</b></sub></a><br /><a href="https://github.com/ptkdev/socialmanagertools-fbbot/commits?author=julianxhokaxhiu" title="Code">💻</a></td></tr></table>
